...
var texture_filenames_to_load = [ "sun3.png", "sun2.png", "white.png", "red.png", "blue_material.png", "turquoise_material.png", "text.png", "earth.tga", "moon2.png"];
...
{	this.string_map = { };	this.m_text = new text_line( 20 ); 		this.start_index = 0;	this.tick = 0;
	...
	Debug_Screen.prototype.display = function(time)
	{
			...
			model_transform = mult( model_transform, translate( -15, -5, 10 ) );
